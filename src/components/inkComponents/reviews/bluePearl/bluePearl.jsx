...
import BluePearlSliders from "./bluePearlSliders";

const bottle = require("../../../../assets/images/png/ink/tsuki-yo/tsukiYoHeader.jpg?url");
const shimmer = require("../../../../assets/images/png/ink/bluePearl/bluePearlShimmer.jpg?url");
const shading = require("../../../../assets/images/png/ink/bluePearl/bluePearlShading.jpg?url");
const sheen = require("../../../../assets/images/png/ink/bluePearl/bluePearlSheen.jpg?url");
const swatch = require("../../../../assets/images/png/ink/bluePearl/bluePearlSwatch.jpg?url");
...
export default function BluePearlReview() {
      ...
      >
        <Box className="flex column center textCenter">
          ...
          <Typography variant="h5" sx={{ marginBottom: "20px" }}>
            one of the Shimmertastic series, Blue Pearl is a gorgeous and
            fascinating ink
          </Typography>
        </Box>
        <Box className="flex reviewBodyContent textStart alignStart">
          <Box className="flex reviewBodyContent2 center">
            ...
            <Box className="flex reviewBodyContent textStart alignStart">
              <Typography variant="body1" className="reviewBody">
                One of the things that is most fun about fountain pen inks is
                the ability to use anything from a basic black to a glittery,
                glowy ink reminiscent of late-90's gel pens. While I do not, at
                my core, consider myself an avid shimmer ink fanatic, I do seem
                to own seven at time of writing, so maybe that opinion is in
                need of update. Of all of those shimmer-ers, Diamine's
                Shimmertastic line stands out as eminently usable inks, despite
                their glitz and glam. And of those, Blue Pearl, for me, is King.
              </Typography>
              <Typography variant="body1" className="reviewBody">
          ...
          <Box className="flex reviewBodyContent2 center">
            <Box className="flex column reviewTextMobile alignStart textStart">
            ...
            <Box className="flex">
              <div className="flex column">
                <img
                  src={shimmer}
                  onClick={() => handleImageClick(shimmer)}
                ...
                >
                  blue base, pink sheen, blue/silver shimmer - cosmo air light
                  paper, pilot custom heritage 92 (m)
                </Typography>
              </div>
            </Box>
          </Box>
          <Box className="flex reviewBodyContent2 center">
            <div className="flex column">
              ...
              >
                prominent pink sheen - cosmo air light paper, pilot custom
                heritage 92 (m)
              </Typography>
            </div>
