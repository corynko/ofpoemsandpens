...
import LieDeTheSliders from "./lieDeTheSliders";

const bottle = require("../../../../assets/images/png/ink/lieDeThe/lieDeTheBottle.jpg?url");
...
export default function LieDeTheReview() {
      ...
      >
        <Box className="flex column center textCenter">
          ...
          <Typography variant="h5" sx={{ marginBottom: "20px" }}>
            a beautiful, sun-tanned-leather brown ink. Will leaning even harder
            into this aesthetic lead to the brown I've been looking for?
          </Typography>
        </Box>
