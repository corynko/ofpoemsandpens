...
export default function SherwoodSliders() {
  const sliderStyles = {
    "& .MuiSlider-track": {
      color: "#025326",
      opacity: 1,
        ...
        <Box sx={{ width: "70vw" }} className="flex between wrap">
          ...
          <div className="flex center column" style={{ width: "25vw" }}>
            ...
            <Slider
              ...
              defaultValue={75}
              step={null}
              marks={getFilteredMarks("wetness", 75)}
              valueLabelDisplay="auto"
              slots={{ ValueLabel: ValueLabelComponent }}
              slotProps={{
          ...
          <div className="flex center column" style={{ width: "25vw" }}>
            ...
            <Slider
              ...
              defaultValue={100}
              step={null}
              marks={getFilteredMarks("drytime", 100)}
              valueLabelDisplay="auto"
              slots={{ ValueLabel: ValueLabelComponent }}
              slotProps={{
          ...
          <div className="flex center column" style={{ width: "25vw" }}>
            ...
            <Slider
              ...
              defaultValue={50}
              step={null}
              marks={getFilteredMarks("easeofclean", 50)}
              valueLabelDisplay="auto"
              slots={{ ValueLabel: ValueLabelComponent }}
              slotProps={{
          ...
          <div className="flex center column" style={{ width: "25vw" }}>
            ...
            <Slider
              ...
              defaultValue={100}
              step={null}
              marks={getFilteredMarks("valueformoney", 100)}
              valueLabelDisplay="auto"
              slots={{ ValueLabel: ValueLabelComponent }}
              slotProps={{
